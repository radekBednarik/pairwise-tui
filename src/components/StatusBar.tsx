...
export function StatusBar({ activeTab, activePanel, addingParam, hasResults, activeOptionField }: StatusBarProps) {
  const hints = getHints(activeTab, activePanel, addingParam, hasResults, activeOptionField)
