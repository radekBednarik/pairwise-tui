...
export function OptionsTab({
  ...
  return (
    <box flexDirection="column" padding={2} gap={1} flexGrow={1}>
      <text fg="#5fafff"><strong>Output Configuration</strong></text>

      <box flexDirection="row" gap={2} alignItems="center">
        <text fg="#aaaaaa" width={20}>Output file path:</text>
        <input
          value={outputConfig.filePath}
          onChange={(v) => onOutputConfigChange({ ...outputConfig, filePath: v })}
      ...
      <box flexDirection="row" gap={2} alignItems="center">
        <text fg="#aaaaaa" width={20}>Format:</text>
        <box
          border
      ...
      <text fg="#5fafff"><strong>PICT Options</strong></text>

      <box flexDirection="row" gap={2} alignItems="center">
        <text fg="#aaaaaa" width={20}>Combination order:</text>
        <input
      ...
      <box
        ...
        alignItems="center"
        paddingX={1}
        backgroundColor={activeField === 'randomize' ? '#1a2a4a' : 'transparent'}
      >
        <text fg="#aaaaaa" width={20}>Randomize:</text>
      ...
      <box
        ...
        alignItems="center"
        paddingX={1}
        backgroundColor={activeField === 'caseSensitive' ? '#1a2a4a' : 'transparent'}
      >
        <text fg="#aaaaaa" width={20}>Case sensitive:</text>
